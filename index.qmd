...
# usamos la funcion "for" e identamos para que el circuito se repita la cantidad de Stock Symbols que agregamos al codigo
...
fig.update_layout(title='Candlestick Chart - Stocks(notese los filtros en los simbolos de la derecha al hacerles click)',
                  xaxis_title='Date',
                  yaxis_title='Stock Price',
                  xaxis_rangeslider_visible=True)
